...
教程目录的“把整本手记带走”提供完整 PDF、单文件 LaTeX 源码和源码 ZIP；各章页尾也可下载整本。作者 **[Ziyu Peng](https://pzy54154631-hub.github.io/homepage/)** 与 **[刘毅涵](https://pzy54154631-hub.github.io/liuyihan/)** 的姓名分别链接到各自的个人主页。下载版按姓名及学校分行署名。
