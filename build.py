...
def author_name(name):
    if name in ('Ziyu.Peng', 'Ziyu Peng'):
        return f'<a class="author-link" href="{AUTHOR_HOME}" rel="author">Ziyu Peng ↗</a>'
    if name == "刘毅涵":
        return f'<a class="author-link" href="{YIHAN_HOME}" rel="author">刘毅涵 ↗</a>'
    return e(name)

def tutorial_license():
    return f'''<aside class="tutorial-license"><span class="license-badge">MIT · 开源教程</span><p>本教程的正文、PDF、LaTeX 源码与原创示例采用 <a href="https://opensource.org/license/mit" rel="license">MIT 协议</a>。你可以自由编辑、复制、再发布及商用；再发布时请保留版权与许可声明。</p><p class="license-credit">© 2026 {author_name('Ziyu Peng')} · {author_name('刘毅涵')} <span aria-hidden="true">/</span> <a href="{TUTORIAL_ASSETS}/LICENSE.txt">阅读完整许可</a> · <a href="{TUTORIAL_ASSETS}/NOTICE.md">许可适用范围</a></p></aside>'''
